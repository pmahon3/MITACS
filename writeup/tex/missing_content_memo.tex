...
The empirical question is whether the Gaussian
$\mathrm{D\_RATIO} = 29$ (S1) was driven mainly by the kernel-family
mismatch or mainly by the cross-scale defect. If
$\mathrm{D\_RATIO}_{\Studt}$ at the same $(h^{*}, g^{*})$ shrinks
toward $1$, the family was the dominant issue and picture (C)
collapses toward (A) under the correct kernel; if it stays
$\gtrsim 5$, picture (C) survives the family lift and the seed's
working hypothesis is corroborated independent of family.
