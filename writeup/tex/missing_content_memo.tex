...
Thread (kernel-family case)
  & \texttt{2026-05-26\_distributional-class-thread}
  & \texttt{state = active}, \texttt{current = Q2D} (pending amendment) \\
S8 (Q1 settled)
  & \texttt{2026-05-26\_q1-student-t-vs-gaussian}
