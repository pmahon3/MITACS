...
whose error structure is folded into the dynamics)? The benign
reading is the simpler one and the place to start. It makes a
testable prediction: if it holds exactly, the error structure should
not vary with the climatology's seasonal resolution. To test it, the
pipeline was re-run under climatology specs of varying resolution
