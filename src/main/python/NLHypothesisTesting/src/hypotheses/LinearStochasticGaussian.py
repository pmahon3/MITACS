...
class LinearStochasticGaussian(NonlinearHypothesis):
    """ Class LinearStochasticGaussian is a nonlinear hypothesis test (abstract class NonlinearHypothesis) with
    null hypothesis that the data is generated from a linear stochastic function with gaussian inputs. For details see:
