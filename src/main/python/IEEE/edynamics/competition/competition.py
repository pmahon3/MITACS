...
library_times = data.loc[
    pd.Timestamp("2020-09-01") : Timestamp("2021-01-01 07:00:00") :
].index
training_times = data.loc[
    Timestamp("2021-01-01 07:00:00") : pd.Timestamp("2021-01-15 07:00:00")
].index
prediction_times = data.loc[
    pd.Timestamp("2021-01-18 07:00:00") : Timestamp("2021-02-01 07:00:00")
].index
