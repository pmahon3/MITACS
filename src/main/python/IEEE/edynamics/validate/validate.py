...
library_times = data.loc[pd.Timestamp('2020-09-01'):pd.Timestamp('2020-12-21 07:00:00')].index
train_times = data.loc[pd.Timestamp('2020-12-21 07:00:00'):pd.Timestamp('2021-01-04 07:00:00')].index
